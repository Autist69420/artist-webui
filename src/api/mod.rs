...
use crate::{AppState, ArtistInventoryInformation, ArtistTurtleInformation, ArtistFurnaceInformation};
...
pub async fn turtle_information(state: web::Data<Arc<RwLock<AppState>>>) -> impl Responder {
    ...
    info!("{} {}", artist.turtle_information.name, artist.turtle_information.id);
